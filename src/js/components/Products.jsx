...
export default class Products extends Component {
  ...
  render() {
            ...
            <div className='item-wrapper'>
              ...
              <div className='item-content'>
                ...
                <div>
                  ...
                  <div className='item-price'>{product.price}{lang.no.currency}</div>
    ...
    return (
      <section id='items'>
        <h2>{lang.no.itemList}</h2>
        <h3>({items.length} {lang.no.found})</h3>
        <div id='items-layout'>
          <button onClick={this.listView}>{lang.no.listView}</button>
          <button onClick={this.gridView}>{lang.no.gridView}</button>
        </div>
